...
from advent.high_entropy_passphrases import HighEntropyPassphrases


class TestHighEntropyPassphrases(TestCase):
    official_input = """vxjtwn vjnxtw sxibvv mmws wjvtxn icawnd rprh
    ...
    def test_is_valid_1(self):
        self.assertTrue(HighEntropyPassphrases.is_valid('aa bb cc dd ee'))

    def test_is_valid_2(self):
        self.assertFalse(HighEntropyPassphrases.is_valid('aa bb cc dd aa'))

    def test_is_valid_3(self):
        self.assertTrue(HighEntropyPassphrases.is_valid('aa bb cc dd aaa'))
